export default {
  ...
  // uploadUrlData: [
  //       { title: "深圳市农业发展专项资金远洋渔业项目申报表", data: []  },
  //       { title: "新建或购买远洋渔业渔船情况统计表", data: []  },
  //       { title: "建造南沙骨干渔船情况统计表", data: []  },
  //       { title: "入渔费用（境外渔业资源使用费）情况统计表", data: []  },
  //       { title: "自捕远洋海产品回运量情况统计表", data: []  },
  //       {
  //         title:
  //           "自捕南沙海产品回运量情况统计表", data: []
  //       },
