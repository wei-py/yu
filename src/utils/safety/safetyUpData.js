...
export function safetyClearData(Data) {
  for (let item in Data.SafetyData) {
    if (
      Object.prototype.toString.call(Data.SafetyData[item]) === "[object Array]"
    ) {
    ...
    if (
      Object.prototype.toString.call(Data.SafetyData[item]) ===
      "[object Object]"
    ) {
      for (let res in Data.SafetyData[item]) {
        Data.SafetyData[item][res] = "";
      }
    }
  }
