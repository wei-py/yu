...
export default {
  ...
  computed: {
    ...
    agriculturalShareholder: {
      get() {
        //this.Agricul.AgriculData.agriculturalShareholder[0].task_id = this.Agricul.userTaskId
  ...
  watch: {
    ...
    agriculturalShareholderTable(n) {
      if (n != null) {
        console.log(n, "股权信息值-----");
        this.Agricul.AgriculData.agriculturalShareholder = n;
      }
    },
  },
  methods: {
