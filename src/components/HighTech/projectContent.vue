    ...
    >
      ...
      <el-form-item label="1、项目实施背景：" prop="background">
        <el-input
          ...
          resize="none"
          rows="10"
          v-model="techImplement.background"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="2、项目实施必要性：" prop="necessity">
        <el-input
          ...
          resize="none"
          rows="10"
          v-model="techImplement.necessity"
        ></el-input>
      </el-form-item>
      ...
      >
        <el-input
          ...
          resize="none"
          rows="10"
          v-model="techImplement.social_results"
        ></el-input>
      </el-form-item>
      ...
      <el-form-item label="6、其他需要重点说明的情况：">
        <el-input
          ...
          resize="none"
          rows="10"
          v-model="techImplement.other_explain"
        ></el-input>
      </el-form-item>
    </el-form>
  </div>
  ...
  computed: {
    ...
    techImplement: {
      get() {
        ...
        //this.HighTech.HighTechData.techImplement.creator = this.HighTech.userName
        return this.HighTech.HighTechData.techImplement;
      },
      set(val) {
        console.log(val);
        this.techImplement = val;
      },
    },
    isDisabledData: {
      get() {
