        ...
        <el-col :span="5"
          ><div class="grid-content bg-purple">
            <el-input
              ...
              v-model="safetyCauses[2][item.Model]"
            ></el-input>
          </div>
        </el-col>
        <el-col :span="5"
          ><div class="grid-content bg-purple">
            <el-input
              type="number"
              :disabled="isDisabledData"
              v-model="safetyCauses[1][item.Model]"
            ></el-input>
          </div>
        </el-col>
        <el-col :span="5"
          ><div class="grid-content bg-purple">
            <el-input
              type="number"
              :disabled="isDisabledData"
              v-model="safetyCauses[0][item.Model]"
            ></el-input>
          </div>
        </el-col>
      </el-row>
...
<script>
import inancialUnderData from "../../static/SafetyData/inancialUnderData";
