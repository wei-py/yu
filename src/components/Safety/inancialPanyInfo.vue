        ...
        <el-col :span="5"
          ><div class="grid-content bg-purple">
            <el-input
              ...
              "
              type="number"
              v-model="safetyFinances[2][item.Model]"
            ></el-input></div
        ></el-col>
        <el-col :span="5"
          ><div class="grid-content bg-purple">
            <el-input
              ...
              "
              type="number"
              v-model="safetyFinances[1][item.Model]"
            ></el-input></div
        ></el-col>
        <el-col :span="5"
          ><div class="grid-content bg-purple">
            <el-input
              ...
              "
              type="number"
              v-model="safetyFinances[0][item.Model]"
            ></el-input></div
        ></el-col>
      </el-row>
    </div>
...
<script>
import inancialPanyList from "../../static/SafetyData/inancialPanyData";
